...
if ( ! defined( 'ABSPATH' ) ) {
	...
	$email_form = '<form id="vscf" class="'.$vscf_atts['class'].'" method="post">
		...
		<div'.(($subject_setting == "yes") ? ' class="form-group vscf-hide"' : ' class="form-group vscf-subject-group"').'>
		...
		<div'.(($privacy_setting != "yes") ? ' class="form-group vscf-hide"' : ' class="form-group vscf-privacy-group"').'>
