...
if ( ! defined( 'ABSPATH' ) ) {
	...
	$email_form = '<form id="vscf" class="'.$vscf_atts['class'].'" method="post">
		<div class="form-group">
			...
			<input type="text" name="vscf_name" id="vscf_name" '.(isset($error_class['form_name']) ? ' class="form-control error"' : ' class="form-control"').' maxlength="'.$vscf_atts['maxlength_textfield'].'" value="'.esc_attr($form_data['form_name']).'" />
		</div>
		<div class="form-group">
			...
			<input type="email" name="vscf_email" id="vscf_email" '.(isset($error_class['form_email']) ? ' class="form-control error"' : ' class="form-control"').' maxlength="'.$vscf_atts['maxlength_textfield'].'" value="'.esc_attr($form_data['form_email']).'" />
		</div>
		<div'.(isset($hide_subject) ? ' class="vscf-hide"' : ' class="form-group"').'>
			...
			<input type="text" name="vscf_subject" id="vscf_subject" '. (isset($error_class['form_subject']) ? ' class="form-control error"' : ' class="form-control"').' maxlength="'.$vscf_atts['maxlength_textfield'].'" value="'.esc_attr($form_data['form_subject']).'" />
		</div>
		<div class="form-group">
			...
			<input type="text" name="vscf_captcha" id="vscf_captcha" '.(isset($error_class['form_captcha']) ? ' class="form-control error"' : ' class="form-control"').' maxlength="'.$vscf_atts['maxlength_textfield'].'" value="'.esc_attr($form_data['form_captcha']).'" />
		</div>
		<div class="form-group vscf-hide">
			<input type="text" name="vscf_firstname" id="vscf_firstname" class="form-control" maxlength="'.$vscf_atts['maxlength_textfield'].'" value="'.esc_attr($form_data['form_firstname']).'" />
		</div>
		<div class="form-group vscf-hide">
			<input type="text" name="vscf_lastname" id="vscf_lastname" class="form-control" maxlength="'.$vscf_atts['maxlength_textfield'].'" value="'.esc_attr($form_data['form_lastname']).'" />
		</div>
		<div class="form-group">
			...
			<textarea name="vscf_message" id="vscf_message" rows="10" '.(isset($error_class['form_message']) ? ' class="form-control error"' : ' class="form-control"').' maxlength="'.$vscf_atts['maxlength_textarea'].'">'.esc_textarea($form_data['form_message']).'</textarea>
		</div>
