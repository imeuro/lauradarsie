...
function vscf_field_callback_22() {
	...
	echo "<input type='text' size='40' maxlength='500' name='vscf-setting-22' placeholder='$vscf_placeholder' value='$vscf_setting' />";
}
...
function vscf_field_callback_5() {
	...
	echo "<input type='text' size='40' maxlength='500' name='vscf-setting-5' placeholder='$vscf_placeholder' value='$vscf_setting' />";
}
...
function vscf_field_callback_6() {
	...
	echo "<input type='text' size='40' maxlength='500' name='vscf-setting-6' placeholder='$vscf_placeholder' value='$vscf_setting' />";
}
...
function vscf_field_callback_7() {
	...
	echo "<input type='text' size='40' maxlength='500' name='vscf-setting-7' placeholder='$vscf_placeholder' value='$vscf_setting' />";
}
...
function vscf_field_callback_8() {
	...
	echo "<input type='text' size='40' maxlength='500' name='vscf-setting-8' placeholder='$vscf_placeholder' value='$vscf_setting' />";
}
...
function vscf_field_callback_9() {
	...
	echo "<input type='text' size='40' maxlength='500' name='vscf-setting-9' placeholder='$vscf_placeholder' value='$vscf_setting' />";
}
...
function vscf_field_callback_18() {
	...
	echo "<input type='text' size='40' maxlength='500' name='vscf-setting-18' placeholder='$vscf_placeholder' value='$vscf_setting' />";
}
...
function vscf_field_callback_10() {
	...
	echo "<input type='text' size='40' maxlength='500' name='vscf-setting-10' placeholder='$vscf_placeholder' value='$vscf_setting' />";
}
...
function vscf_field_callback_11() {
	...
	echo "<input type='text' size='40' maxlength='500' name='vscf-setting-11' placeholder='$vscf_placeholder' value='$vscf_setting' />";
}
...
function vscf_field_callback_13() {
	...
	echo "<input type='text' size='40' maxlength='500' name='vscf-setting-13' placeholder='$vscf_placeholder' value='$vscf_setting' />";
}

function vscf_field_callback_20() {
	$vscf_placeholder = esc_attr__( 'Please enter at least 2 characters', 'very-simple-contact-form' );
	$vscf_setting = esc_attr( get_option( 'vscf-setting-20' ) );
	echo "<input type='text' size='40' maxlength='500' name='vscf-setting-20' placeholder='$vscf_placeholder' value='$vscf_setting' />";
}
...
function vscf_field_callback_14() {
	...
	echo "<input type='text' size='40' maxlength='500' name='vscf-setting-14' placeholder='$vscf_placeholder' value='$vscf_setting' />";
}
...
function vscf_field_callback_12() {
	...
	echo "<input type='text' size='40' maxlength='500' name='vscf-setting-12' placeholder='$vscf_placeholder' value='$vscf_setting' />";
}
...
function vscf_field_callback_15() {
	...
	echo "<input type='text' size='40' maxlength='500' name='vscf-setting-15' placeholder='$vscf_placeholder' value='$vscf_setting' />";
}
...
function vscf_field_callback_16() {
	...
	echo "<input type='text' size='40' maxlength='500' name='vscf-setting-16' placeholder='$vscf_placeholder' value='$vscf_setting' />";
}

function vscf_field_callback_17() {
	$vscf_placeholder = esc_attr__( 'Thank you! You will receive a response as soon as possible.', 'very-simple-contact-form' );
	$vscf_setting = esc_attr( get_option( 'vscf-setting-17' ) );
	echo "<input type='text' size='40' maxlength='500' name='vscf-setting-17' placeholder='$vscf_placeholder' value='$vscf_setting' />";
	?>
